...
(function () {
  ...
  /* アバター背景のグラデーション配色（落ち着いたスチール／グラファイト調） */
  const GRADIENTS = [
    ['#5b6b80', '#38445a'], ['#616a7a', '#3d4350'], ['#5f5a70', '#3c384c'],
    ['#54706c', '#354a47'], ['#6d6656', '#48432f'], ['#6a5866', '#453644'],
    ['#4f6a80', '#324356'], ['#6a707a', '#454a52'], ['#5e6e5c', '#3c473b'],
    ['#736560', '#4a403c'], ['#4f6678', '#2f4150'], ['#66607a', '#413c52'],
  ];
  ...
  /* 服はビジネストーン（ネイビー・チャコール・バーガンディ等） */
  const CLOTH_COLORS = ['#2e4468', '#3d4550', '#6b3a49', '#2f5450', '#4a4066', '#585038', '#3a5c74', '#494540', '#274058', '#5c2f38'];
